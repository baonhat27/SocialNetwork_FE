        ...
        <div className={styles.profilePage}>
            ...
            <div className={styles.avatarBackground}>
                <div className={styles.avatarBox}>
                    ...
                    {!props.friend?<i onClick={function(){props.setSelectedAvatarForm(true)}} className={"fa-solid fa-camera "+styles.icon_camera}></i>:<></>}
                ...
                <div className={styles.bodyCol}>
                    <div className={styles.infomationCol}>
                        ...
                        <p className={styles.infomationCol_line}>
                            <i className={"fa-solid fa-envelope"+" "+styles.icon}></i>Email: {props.user.email} 
                        </p>
                        <p className={styles.infomationCol_line}>
                            <i className={"fa-solid fa-cake-candles"+" "+styles.icon}></i>Ngày sinh: {new Date(props.user.dateOfBirth).getDate()+"/"+(new Date(props.user.dateOfBirth).getMonth()+1)+"/"+new Date(props.user.dateOfBirth).getFullYear()} 
                        </p>
                        <p className={styles.infomationCol_line}>
                            <i className={"fa-solid fa-mars-and-venus"+" "+styles.icon}></i>Giới tính: {props.user.gender?"Nữ":"Nam"} 
                        </p>
                        <p className={styles.infomationCol_line}>
                            <i className={"fa-solid fa-clock"+" "+styles.icon}></i>Ngày tham gia: {new Date(props.user.createdAt).getDate()+"/"+(new Date(props.user.createdAt).getMonth()+1)+"/"+new Date(props.user.createdAt).getFullYear()} 
                        </p>
