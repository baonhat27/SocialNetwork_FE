    ...
    return (
        <div className={styles.loginPage}>
            <div className={styles.social}>
                ...
                <p className={styles.describes}>Social-network giúp bạn kết nối và chia sẻ với mọi người trong cuộc sống của bạn.</p>
            </div>
            <div className={styles.box}>
                <div className={props.showSignUp?styles.scroll+" "+styles.show:styles.scroll}>
                    <div className={styles.login}>
                        ...
                        <Button style={{background:"#42b72a"}} onClick={function(){props.setShowSignUp(true)}}>Tạo tài khoản mới</Button>
                    </div>
                    <div className={styles.signup}>
                        ...
                        <Button style={{background:"#42b72a"}} onClick={function(){props.setShowSignUp(false)}}>Đăng nhập</Button>
                    </div>
                </div>
            </div>
        </div>
